...
\begin{tikzpicture}[
  ...
  \draw[black!50, text=black, fill=blue!15] (Nut-3) circle [radius=.15] node {\tiny G};
  \draw[black!100] (Nut-2) node {\tiny D};
    % do a C major chord
  \draw[black!100,fill=blue!15]            (4-1) circle [radius=.15] node {\tiny C};
  \draw[black!40, text=black,fill=blue!15] (2-2) circle [radius=.15] node {\tiny E};
  \draw[black!40, text=black,fill=blue!15] (5-2) circle [radius=.15] node {\tiny E};
